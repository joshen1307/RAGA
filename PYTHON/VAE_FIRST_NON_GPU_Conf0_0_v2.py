...
def save_checkpoint(epoch):
    ...
    torch.save(vae.state_dict(), '/raid/scratch/davidb/1_DEVELOPMENT/VAE_FIRST/models/file_conf3_semi_supervised_vae_FRDEEP_epoch_'+str(epoch))
    print("saving optimizer states...")
    optimizer.save('/raid/scratch/davidb/1_DEVELOPMENT/VAE_FIRST/models/file_conf3_semi_supervised_vae_FRDEEP_epoch_'+str(epoch)+'_opt')
